...
type UserServiceClient interface {
	...
	GetAllUsers(ctx context.Context, in *PaginationRequest, opts ...grpc.CallOption) (*UserListResponse, error)
}
...
func (c *userServiceClient) GetAllUsers(ctx context.Context, in *PaginationRequest, opts ...grpc.CallOption) (*UserListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	GetAllUsers(context.Context, *PaginationRequest) (*UserListResponse, error)
...
func (UnimplementedUserServiceServer) GetAllUsers(context.Context, *PaginationRequest) (*UserListResponse, error) {
...
func _UserService_GetAllUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetAllUsers(ctx, req.(*PaginationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
